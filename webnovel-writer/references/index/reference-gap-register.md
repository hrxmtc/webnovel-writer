...
|-------|----------|-----------------|-------------|---------------------|-------------------|
| webnovel-write | P0 | 326 行，主链过重，references 平铺式列出 | 主链总控 skill：流程+闸门+交付物+恢复 | anti-ai-guide, polish-guide, style-adapter, style-variants, writing/* (6 files), reading-power-taxonomy, genre-profiles, core-constraints | 命名规则 CSV, 场景写法 CSV, AI 味替换 CSV |
...
| `references/csv/写作技法.csv`（候选） | 从现有 writing/*.md 迁移 | write | 对话声线、AI味替换、情感描写等技法条目 |
